        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/d.o.m.eventagency" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-[#C0A07B] hover:border-[#C0A07B] hover:text-black transition-all cursor-pointer">
                <Instagram size={20} />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61554741856673" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-[#C0A07B] hover:border-[#C0A07B] hover:text-black transition-all cursor-pointer">
                <Facebook size={20} />
              </a>
            </div>
            <div className="mt-12 text-xs text-gray-500 font-light leading-relaxed">
          ...
          <div className="flex flex-col gap-4 font-light text-right md:items-end">
