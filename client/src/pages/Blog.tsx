      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-5xl">
          <motion.h1 
            ...
            className="text-4xl md:text-5xl font-serif text-[#C0A07B] mb-12 text-center"
          >
            {t("blog.title")}
          </motion.h1>
            ...
            <div className="grid gap-8">
              {posts.map((post, index) => (
                <motion.article
                  ...
                  className="bg-[#1a1a1a] rounded-lg overflow-hidden hover:bg-[#222] transition-colors group"
                >
                  <Link href={`/blog/${post.slug}`}>
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className={`p-6 flex flex-col justify-center ${post.featuredImageUrl ? "md:w-2/3" : "w-full"}`}>
                        <h2 className="text-xl md:text-2xl font-serif text-white mb-3 group-hover:text-[#C0A07B] transition-colors">
