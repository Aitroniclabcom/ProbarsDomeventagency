...
export const translations = {
  ...
  ru: {
    ...
    shop: {
      ...
      products: {
        tshirt: { name: "Футболка D.O.M.", desc: "Футболка из высококачественного хлопка с минималистичным логотипом." },
    ...
    services: {
      ...
      music: {
        title: "DJ / MUSIC",
        desc: "DJ/MUSIC превращает звучание мероприятия в эстетическое и эмоциональное путешествие. Мы не просто играем музыку, мы создаем звуковой дизайн, который определяет атмосферу и ритм вечера.",
        ...
        adv2: "Визуальная и аудио гармония: Виниловые проигрыватели как элемент стиля.",
    ...
    team: {
      title: "НАША КОМАНДА",
      subtitle: "Мы — команда профессионалов, объединяющая опыт, творчество и страсть для создания незабываемых мероприятий.",
