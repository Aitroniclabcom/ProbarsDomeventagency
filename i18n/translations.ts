...
export const translations = {
  lv: {
    ...
    checkout: {
      ...
      delivery: "Piegāde",
      courier: "Kurjers",
      deliveryFree: "Bezmaksas",
      deliveryMethod: "Piegādes veids",
      courierDays: "1–3 darba dienas",
      sameAddress: "Piegādes adrese sakrīt ar pircēja adresi",
      deliveryAddress: "Piegādes adrese",
      postcode: "Pasta indekss",
      digitalDelivery: "Digitāla piegāde e-pastā — bez sūtīšanas.",
  ...
  ru: {
    ...
    checkout: {
      ...
      courierDays: "1–3 рабочих дня",
      sameAddress: "Адрес доставки совпадает с адресом покупателя",
      deliveryAddress: "Адрес доставки",
      postcode: "Почтовый индекс",
      digitalDelivery: "Цифровая доставка по e-mail — без отправки.",
  ...
  en: {
    ...
    checkout: {
      ...
      courierDays: "1–3 business days",
      sameAddress: "Delivery address same as billing",
      deliveryAddress: "Delivery address",
      postcode: "Postal code",
      digitalDelivery: "Digital delivery by email — no shipping.",
